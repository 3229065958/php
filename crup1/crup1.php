...
<a href="agregar.php" class="btn btn-success">agregar</a>
  ...
  <thead>
    ...
    $sql= ("SELECT *FROM productos INNER JOIN categorias on productos.idcategorias=categorias.idcategoria INNER JOIN marcas on productos.idmarcas=marcas.idmarcas;");
